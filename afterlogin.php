        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Convrt.php">Convert</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">More Tools</a>
                ...
                <div class="navbar-text text-info " id="loguname" >
                        <?php 
                        echo $_SESSION['UName'];
                        ?>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <a href="Convrt.php" class="btn btn-primary" id="conbtn">Convert</a>
                </div>
